...
class AltitudeServiceAdapter @Autowired constructor(private val objectMapper: ObjectMapper,
                                                    @Value("\${microservice.openAltitude:8080") private val portToAltitudeService : Int,
                                                    @Value("\${microservice.openAltitude:127.0.0.1") private val hostToAltitudeService : String) {
